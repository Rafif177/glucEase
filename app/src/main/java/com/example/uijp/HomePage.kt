...
fun HomeScreen(navController: NavController) {
    Column(
        ...
        Row(
            ...
            StatistikCard(title = "Gula Darah", value = "110 mg/dL")
            StatistikCard(title = "Asupan Gula", value = "32g / 40g")
        }
        ...
        Row(
            ...
            FeatureButton("Konsultasi", painterResource(id = R.drawable.docs)) {
            ...
            FeatureButton("Tracker Gula Darah", painterResource(id = R.drawable.charts)) {
                navController.navigate("guladarah")
            }
            FeatureButton("Reward", painterResource(id = R.drawable.gift)) {
...
@Composable
fun StatistikCard(title: String, value: String) {
    Card(
        modifier = Modifier
            .height(80.dp),
