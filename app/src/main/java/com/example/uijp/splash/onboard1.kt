...
fun Onboard1(navController: NavController) {
    Column(
        ...
        Box(
            ...
            Image(
                painter = painterResource(id = R.drawable.image_118),
        ...
        Column(
            ...
            Text(
                text = "Cek Gula Darah Jadi\nLebih Praktis dan Teratur",
            ...
            Text(
                text = "Pantau progresmu langsung dari\naplikasi setiap minggu.",
            ...
            Button(
                onClick = {
                    navController.navigate("onboard2") // ganti dengan nama route selanjutnya
                },
